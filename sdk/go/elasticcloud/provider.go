...
func NewProvider(ctx *pulumi.Context,
	...
	if args.Apikey == nil {
		args.Apikey = pulumi.StringPtr(getEnvOrDefault("", nil, "EC_API_KEY").(string))
	}
	if args.Endpoint == nil {
		args.Endpoint = pulumi.StringPtr("")
	}
	if args.Insecure == nil {
		args.Insecure = pulumi.BoolPtr(false)
	}
	if args.Password == nil {
		args.Password = pulumi.StringPtr(getEnvOrDefault("", nil, "EC_PASS", "EC_PASSWORD").(string))
	}
	if args.Timeout == nil {
		args.Timeout = pulumi.StringPtr("1m")
	}
	if args.Username == nil {
		args.Username = pulumi.StringPtr(getEnvOrDefault("", nil, "EC_USER", "EC_USERNAME").(string))
	}
	if args.Verbose == nil {
		args.Verbose = pulumi.BoolPtr(false)
	}
	if args.VerboseCredentials == nil {
		args.VerboseCredentials = pulumi.BoolPtr(false)
	}
	if args.VerboseFile == nil {
		args.VerboseFile = pulumi.StringPtr("request.log")
	}
