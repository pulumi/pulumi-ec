...
namespace Pulumi.ElasticCloud.Inputs
{
    ...
    public sealed class DeploymentElasticsearchHotGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Optional Elasticsearch autoscaling settings, such a maximum and minimum size and resources.
        /// </summary>
        [Input("autoscaling", required: true)]
        public Input<Inputs.DeploymentElasticsearchHotAutoscalingGetArgs> Autoscaling { get; set; } = null!;
        ...
        public DeploymentElasticsearchHotGetArgs()
        {
        }
        public static new DeploymentElasticsearchHotGetArgs Empty => new DeploymentElasticsearchHotGetArgs();
    }
}
