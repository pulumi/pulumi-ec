...
namespace Pulumi.ElasticCloud.Inputs
{
    ...
    public sealed class DeploymentElasticsearchMlAutoscalingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public DeploymentElasticsearchMlAutoscalingArgs()
        {
        }
        public static new DeploymentElasticsearchMlAutoscalingArgs Empty => new DeploymentElasticsearchMlAutoscalingArgs();
    }
}
