...
namespace Pulumi.ElasticCloud.Inputs
{
    ...
    public sealed class DeploymentElasticsearchCoordinatingAutoscalingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public DeploymentElasticsearchCoordinatingAutoscalingArgs()
        {
        }
        public static new DeploymentElasticsearchCoordinatingAutoscalingArgs Empty => new DeploymentElasticsearchCoordinatingAutoscalingArgs();
    }
}
