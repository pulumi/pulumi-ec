...
namespace Pulumi.ElasticCloud.Inputs
{
    ...
    public sealed class DeploymentElasticsearchColdArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Optional Elasticsearch autoscaling settings, such a maximum and minimum size and resources.
        /// </summary>
        [Input("autoscaling", required: true)]
        public Input<Inputs.DeploymentElasticsearchColdAutoscalingArgs> Autoscaling { get; set; } = null!;
        ...
        public DeploymentElasticsearchColdArgs()
        {
        }
        public static new DeploymentElasticsearchColdArgs Empty => new DeploymentElasticsearchColdArgs();
    }
}
