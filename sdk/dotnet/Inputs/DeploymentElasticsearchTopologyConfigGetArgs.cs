...
namespace Pulumi.ElasticCloud.Inputs
{
    ...
    public sealed class DeploymentElasticsearchTopologyConfigGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("plugins")]
        ...
        public DeploymentElasticsearchTopologyConfigGetArgs()
        {
        }
        public static new DeploymentElasticsearchTopologyConfigGetArgs Empty => new DeploymentElasticsearchTopologyConfigGetArgs();
    }
}
