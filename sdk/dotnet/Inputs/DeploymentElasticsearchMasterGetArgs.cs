...
namespace Pulumi.ElasticCloud.Inputs
{
    ...
    public sealed class DeploymentElasticsearchMasterGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Optional Elasticsearch autoscaling settings, such a maximum and minimum size and resources.
        /// </summary>
        [Input("autoscaling", required: true)]
        public Input<Inputs.DeploymentElasticsearchMasterAutoscalingGetArgs> Autoscaling { get; set; } = null!;
        ...
        public DeploymentElasticsearchMasterGetArgs()
        {
        }
        public static new DeploymentElasticsearchMasterGetArgs Empty => new DeploymentElasticsearchMasterGetArgs();
    }
}
