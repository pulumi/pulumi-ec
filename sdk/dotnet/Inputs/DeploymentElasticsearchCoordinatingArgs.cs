...
namespace Pulumi.ElasticCloud.Inputs
{
    ...
    public sealed class DeploymentElasticsearchCoordinatingArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Optional Elasticsearch autoscaling settings, such a maximum and minimum size and resources.
        /// </summary>
        [Input("autoscaling", required: true)]
        public Input<Inputs.DeploymentElasticsearchCoordinatingAutoscalingArgs> Autoscaling { get; set; } = null!;
        ...
        public DeploymentElasticsearchCoordinatingArgs()
        {
        }
        public static new DeploymentElasticsearchCoordinatingArgs Empty => new DeploymentElasticsearchCoordinatingArgs();
    }
}
