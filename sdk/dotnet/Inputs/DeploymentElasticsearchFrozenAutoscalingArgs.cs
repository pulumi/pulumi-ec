...
namespace Pulumi.ElasticCloud.Inputs
{
    ...
    public sealed class DeploymentElasticsearchFrozenAutoscalingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public DeploymentElasticsearchFrozenAutoscalingArgs()
        {
        }
        public static new DeploymentElasticsearchFrozenAutoscalingArgs Empty => new DeploymentElasticsearchFrozenAutoscalingArgs();
    }
}
