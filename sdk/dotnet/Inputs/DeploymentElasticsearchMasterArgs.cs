...
namespace Pulumi.ElasticCloud.Inputs
{
    ...
    public sealed class DeploymentElasticsearchMasterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Optional Elasticsearch autoscaling settings, such a maximum and minimum size and resources.
        /// </summary>
        [Input("autoscaling", required: true)]
        public Input<Inputs.DeploymentElasticsearchMasterAutoscalingArgs> Autoscaling { get; set; } = null!;
        ...
        public DeploymentElasticsearchMasterArgs()
        {
        }
        public static new DeploymentElasticsearchMasterArgs Empty => new DeploymentElasticsearchMasterArgs();
    }
}
