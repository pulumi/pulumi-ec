...
namespace Pulumi.ElasticCloud.Inputs
{
    ...
    public sealed class DeploymentElasticsearchColdAutoscalingArgs : global::Pulumi.ResourceArgs
    {
        ...
        public DeploymentElasticsearchColdAutoscalingArgs()
        {
        }
        public static new DeploymentElasticsearchColdAutoscalingArgs Empty => new DeploymentElasticsearchColdAutoscalingArgs();
    }
}
