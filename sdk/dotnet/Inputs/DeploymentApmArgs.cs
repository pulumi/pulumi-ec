...
namespace Pulumi.ElasticCloud.Inputs
{
    ...
    public sealed class DeploymentApmArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("topologies")]
        private InputList<Inputs.DeploymentApmTopologyArgs>? _topologies;

        /// <summary>
        /// Can be set multiple times to compose complex topologies.
        /// </summary>
        public InputList<Inputs.DeploymentApmTopologyArgs> Topologies
        {
            get => _topologies ?? (_topologies = new InputList<Inputs.DeploymentApmTopologyArgs>());
