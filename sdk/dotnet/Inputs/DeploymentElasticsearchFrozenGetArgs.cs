...
namespace Pulumi.ElasticCloud.Inputs
{
    ...
    public sealed class DeploymentElasticsearchFrozenGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Optional Elasticsearch autoscaling settings, such a maximum and minimum size and resources.
        /// </summary>
        [Input("autoscaling", required: true)]
        public Input<Inputs.DeploymentElasticsearchFrozenAutoscalingGetArgs> Autoscaling { get; set; } = null!;
        ...
        public DeploymentElasticsearchFrozenGetArgs()
        {
        }
        public static new DeploymentElasticsearchFrozenGetArgs Empty => new DeploymentElasticsearchFrozenGetArgs();
    }
}
