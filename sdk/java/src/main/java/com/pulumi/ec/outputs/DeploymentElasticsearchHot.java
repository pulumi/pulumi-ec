...
@CustomType
public final class DeploymentElasticsearchHot {
    /**
     * @return Optional Elasticsearch autoscaling settings, such a maximum and minimum size and resources.
     * 
     */
    private DeploymentElasticsearchHotAutoscaling autoscaling;
    /**
     ...
     * 
     */
    public DeploymentElasticsearchHotAutoscaling autoscaling() {
    ...
    public static Builder builder(DeploymentElasticsearchHot defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer zoneCount;
        public Builder() {}
        public Builder(DeploymentElasticsearchHot defaults) {
        ...
        public DeploymentElasticsearchHot build() {
            final var _resultValue = new DeploymentElasticsearchHot();
