...
public final class GetDeploymentIntegrationsServerTopology {
    ...
    public static Builder builder(GetDeploymentIntegrationsServerTopology defaults) {
    ...
    public static final class Builder {
        ...
        private Integer zoneCount;
        public Builder() {}
        public Builder(GetDeploymentIntegrationsServerTopology defaults) {
        ...
        public Builder instanceConfigurationId(String instanceConfigurationId) {
            if (instanceConfigurationId == null) {
              throw new MissingRequiredPropertyException("GetDeploymentIntegrationsServerTopology", "instanceConfigurationId");
            }
        ...
        public Builder size(String size) {
            if (size == null) {
              throw new MissingRequiredPropertyException("GetDeploymentIntegrationsServerTopology", "size");
            }
            this.size = size;
            return this;
        }
        ...
        public Builder sizeResource(String sizeResource) {
            if (sizeResource == null) {
              throw new MissingRequiredPropertyException("GetDeploymentIntegrationsServerTopology", "sizeResource");
            }
        ...
        public Builder zoneCount(Integer zoneCount) {
            if (zoneCount == null) {
              throw new MissingRequiredPropertyException("GetDeploymentIntegrationsServerTopology", "zoneCount");
            }
