...
@CustomType
public final class DeploymentElasticsearchTopologyAutoscaling {
    /**
    ...
    public static Builder builder(DeploymentElasticsearchTopologyAutoscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String policyOverrideJson;
        public Builder() {}
        public Builder(DeploymentElasticsearchTopologyAutoscaling defaults) {
        ...
        public DeploymentElasticsearchTopologyAutoscaling build() {
            final var o = new DeploymentElasticsearchTopologyAutoscaling();
            o.maxSize = maxSize;
