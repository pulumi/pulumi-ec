...
@CustomType
public final class DeploymentElasticsearchWarmAutoscaling {
    /**
    ...
    public static Builder builder(DeploymentElasticsearchWarmAutoscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String policyOverrideJson;
        public Builder() {}
        public Builder(DeploymentElasticsearchWarmAutoscaling defaults) {
        ...
        public DeploymentElasticsearchWarmAutoscaling build() {
            final var _resultValue = new DeploymentElasticsearchWarmAutoscaling();
