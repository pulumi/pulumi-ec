...
@CustomType
public final class DeploymentElasticsearchMasterAutoscaling {
    /**
    ...
    public static Builder builder(DeploymentElasticsearchMasterAutoscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String policyOverrideJson;
        public Builder() {}
        public Builder(DeploymentElasticsearchMasterAutoscaling defaults) {
        ...
        public DeploymentElasticsearchMasterAutoscaling build() {
            final var _resultValue = new DeploymentElasticsearchMasterAutoscaling();
