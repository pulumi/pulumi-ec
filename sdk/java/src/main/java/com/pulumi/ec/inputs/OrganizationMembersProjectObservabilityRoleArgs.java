...
public final class OrganizationMembersProjectObservabilityRoleArgs extends com.pulumi.resources.ResourceArgs {

    public static final OrganizationMembersProjectObservabilityRoleArgs Empty = new OrganizationMembersProjectObservabilityRoleArgs();
    ...
    private OrganizationMembersProjectObservabilityRoleArgs() {}

    private OrganizationMembersProjectObservabilityRoleArgs(OrganizationMembersProjectObservabilityRoleArgs $) {
    ...
    public static Builder builder(OrganizationMembersProjectObservabilityRoleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OrganizationMembersProjectObservabilityRoleArgs();
        }

        public Builder(OrganizationMembersProjectObservabilityRoleArgs defaults) {
            $ = new OrganizationMembersProjectObservabilityRoleArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param role Assigned role. (Allowed values: `admin`, `editor`, `viewer`)
         * 
         * @return builder
         * 
         */
        ...
        public OrganizationMembersProjectObservabilityRoleArgs build() {
            if ($.role == null) {
                throw new MissingRequiredPropertyException("OrganizationMembersProjectObservabilityRoleArgs", "role");
            }
            return $;
        }
    }
