...
public final class DeploymentElasticsearchColdAutoscaling {
    ...
    public static Builder builder(DeploymentElasticsearchColdAutoscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String policyOverrideJson;
        public Builder() {}
        public Builder(DeploymentElasticsearchColdAutoscaling defaults) {
        ...
        public DeploymentElasticsearchColdAutoscaling build() {
            final var _resultValue = new DeploymentElasticsearchColdAutoscaling();
