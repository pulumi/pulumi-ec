...
import com.pulumi.ec.outputs.DeploymentElasticsearchCoordinatingAutoscaling;
...
@CustomType
public final class DeploymentElasticsearchCoordinating {
    /**
    ...
    public static Builder builder(DeploymentElasticsearchCoordinating defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer zoneCount;
        public Builder() {}
        public Builder(DeploymentElasticsearchCoordinating defaults) {
        ...
        @CustomType.Setter
        public Builder autoscaling(DeploymentElasticsearchCoordinatingAutoscaling autoscaling) {
            if (autoscaling == null) {
              throw new MissingRequiredPropertyException("DeploymentElasticsearchCoordinating", "autoscaling");
            }
        ...
        public DeploymentElasticsearchCoordinating build() {
