...
import com.pulumi.ec.outputs.DeploymentElasticsearchMasterAutoscaling;
...
public final class DeploymentElasticsearchMaster {
    ...
    public static Builder builder(DeploymentElasticsearchMaster defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer zoneCount;
        public Builder() {}
        public Builder(DeploymentElasticsearchMaster defaults) {
        ...
        @CustomType.Setter
        public Builder autoscaling(DeploymentElasticsearchMasterAutoscaling autoscaling) {
            if (autoscaling == null) {
              throw new MissingRequiredPropertyException("DeploymentElasticsearchMaster", "autoscaling");
            }
        ...
        public DeploymentElasticsearchMaster build() {
            final var _resultValue = new DeploymentElasticsearchMaster();
