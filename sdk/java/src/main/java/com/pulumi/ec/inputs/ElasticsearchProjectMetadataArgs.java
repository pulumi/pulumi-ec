...
public final class ElasticsearchProjectMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final ElasticsearchProjectMetadataArgs Empty = new ElasticsearchProjectMetadataArgs();
    ...
    public static Builder builder(ElasticsearchProjectMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ElasticsearchProjectMetadataArgs();
        }

        public Builder(ElasticsearchProjectMetadataArgs defaults) {
            $ = new ElasticsearchProjectMetadataArgs(Objects.requireNonNull(defaults));
        }
