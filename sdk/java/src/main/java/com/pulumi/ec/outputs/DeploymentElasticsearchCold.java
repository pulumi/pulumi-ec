...
import com.pulumi.ec.outputs.DeploymentElasticsearchColdAutoscaling;
...
@CustomType
public final class DeploymentElasticsearchCold {
    /**
     * @return Optional Elasticsearch autoscaling settings, such a maximum and minimum size and resources.
     * 
     */
    private DeploymentElasticsearchColdAutoscaling autoscaling;
    /**
     ...
     * 
     */
    public DeploymentElasticsearchColdAutoscaling autoscaling() {
    ...
    public static Builder builder(DeploymentElasticsearchCold defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer zoneCount;
        public Builder() {}
        public Builder(DeploymentElasticsearchCold defaults) {
        ...
        @CustomType.Setter
        public Builder autoscaling(DeploymentElasticsearchColdAutoscaling autoscaling) {
            if (autoscaling == null) {
              throw new MissingRequiredPropertyException("DeploymentElasticsearchCold", "autoscaling");
            }
        ...
        public DeploymentElasticsearchCold build() {
            final var _resultValue = new DeploymentElasticsearchCold();
