    ...
    public static final class Builder {
        ...
        public Builder capacityConstraintsMax(Integer capacityConstraintsMax) {
            if (capacityConstraintsMax == null) {
              throw new MissingRequiredPropertyException("GetStackEnterpriseSearch", "capacityConstraintsMax");
            }
        ...
        public Builder capacityConstraintsMin(Integer capacityConstraintsMin) {
            if (capacityConstraintsMin == null) {
              throw new MissingRequiredPropertyException("GetStackEnterpriseSearch", "capacityConstraintsMin");
            }
        ...
        public Builder compatibleNodeTypes(List<String> compatibleNodeTypes) {
            if (compatibleNodeTypes == null) {
              throw new MissingRequiredPropertyException("GetStackEnterpriseSearch", "compatibleNodeTypes");
            }
        ...
        public Builder denylists(List<String> denylists) {
            if (denylists == null) {
              throw new MissingRequiredPropertyException("GetStackEnterpriseSearch", "denylists");
            }
        ...
        public Builder dockerImage(String dockerImage) {
            if (dockerImage == null) {
              throw new MissingRequiredPropertyException("GetStackEnterpriseSearch", "dockerImage");
            }
