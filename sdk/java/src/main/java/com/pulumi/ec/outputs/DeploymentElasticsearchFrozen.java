...
import com.pulumi.ec.outputs.DeploymentElasticsearchFrozenAutoscaling;
...
@CustomType
public final class DeploymentElasticsearchFrozen {
    /**
     * @return Optional Elasticsearch autoscaling settings, such a maximum and minimum size and resources.
     * 
     */
    private DeploymentElasticsearchFrozenAutoscaling autoscaling;
    /**
     ...
     * 
     */
    public DeploymentElasticsearchFrozenAutoscaling autoscaling() {
    ...
    public static Builder builder(DeploymentElasticsearchFrozen defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer zoneCount;
        public Builder() {}
        public Builder(DeploymentElasticsearchFrozen defaults) {
        ...
        @CustomType.Setter
        public Builder autoscaling(DeploymentElasticsearchFrozenAutoscaling autoscaling) {
            if (autoscaling == null) {
              throw new MissingRequiredPropertyException("DeploymentElasticsearchFrozen", "autoscaling");
            }
        ...
        public DeploymentElasticsearchFrozen build() {
            final var _resultValue = new DeploymentElasticsearchFrozen();
