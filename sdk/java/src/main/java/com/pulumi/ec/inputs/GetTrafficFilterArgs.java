...
public final class GetTrafficFilterArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private GetTrafficFilterArgs() {}

    private GetTrafficFilterArgs(GetTrafficFilterArgs $) {
        this.id = $.id;
        this.name = $.name;
        this.region = $.region;
    }
    ...
    public static Builder builder(GetTrafficFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTrafficFilterArgs();
        }

        public Builder(GetTrafficFilterArgs defaults) {
            $ = new GetTrafficFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetTrafficFilterArgs build() {
            return $;
        }
    }
