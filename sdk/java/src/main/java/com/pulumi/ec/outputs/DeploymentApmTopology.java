...
@CustomType
public final class DeploymentApmTopology {
    /**
    ...
    public static Builder builder(DeploymentApmTopology defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer zoneCount;
        public Builder() {}
        public Builder(DeploymentApmTopology defaults) {
        ...
        public DeploymentApmTopology build() {
            final var o = new DeploymentApmTopology();
