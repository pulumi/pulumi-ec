...
public final class DeploymentApmConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeploymentApmConfigArgs Empty = new DeploymentApmConfigArgs();
    ...
    private DeploymentApmConfigArgs() {}

    private DeploymentApmConfigArgs(DeploymentApmConfigArgs $) {
    ...
    public static Builder builder(DeploymentApmConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeploymentApmConfigArgs();
        }

        public Builder(DeploymentApmConfigArgs defaults) {
            $ = new DeploymentApmConfigArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param debugEnabled Enable debug mode for the component. Defaults to `false`.
         * 
         * @return builder
         * 
         */
        ...
        public DeploymentApmConfigArgs build() {
            return $;
        }
    }
