...
public final class GetDeploymentTemplatesTemplateElasticsearchMasterAutoscaling {
    ...
    public static Builder builder(GetDeploymentTemplatesTemplateElasticsearchMasterAutoscaling defaults) {
    ...
    public static final class Builder {
        ...
        private String minSizeResource;
        public Builder() {}
        public Builder(GetDeploymentTemplatesTemplateElasticsearchMasterAutoscaling defaults) {
        ...
        public Builder autoscale(Boolean autoscale) {
            if (autoscale == null) {
              throw new MissingRequiredPropertyException("GetDeploymentTemplatesTemplateElasticsearchMasterAutoscaling", "autoscale");
            }
        ...
        public Builder maxSize(String maxSize) {
            if (maxSize == null) {
              throw new MissingRequiredPropertyException("GetDeploymentTemplatesTemplateElasticsearchMasterAutoscaling", "maxSize");
            }
        ...
        public Builder maxSizeResource(String maxSizeResource) {
            if (maxSizeResource == null) {
              throw new MissingRequiredPropertyException("GetDeploymentTemplatesTemplateElasticsearchMasterAutoscaling", "maxSizeResource");
            }
        ...
        public Builder minSize(String minSize) {
            if (minSize == null) {
              throw new MissingRequiredPropertyException("GetDeploymentTemplatesTemplateElasticsearchMasterAutoscaling", "minSize");
            }
        ...
        public Builder minSizeResource(String minSizeResource) {
            if (minSizeResource == null) {
              throw new MissingRequiredPropertyException("GetDeploymentTemplatesTemplateElasticsearchMasterAutoscaling", "minSizeResource");
            }
            this.minSizeResource = minSizeResource;
            return this;
        }
        public GetDeploymentTemplatesTemplateElasticsearchMasterAutoscaling build() {
            final var _resultValue = new GetDeploymentTemplatesTemplateElasticsearchMasterAutoscaling();
