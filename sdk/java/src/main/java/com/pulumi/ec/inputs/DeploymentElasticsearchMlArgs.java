...
public final class DeploymentElasticsearchMlArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeploymentElasticsearchMlArgs Empty = new DeploymentElasticsearchMlArgs();
    ...
    private Output<DeploymentElasticsearchMlAutoscalingArgs> autoscaling;

    /**
     * @return Optional Elasticsearch autoscaling settings, such a maximum and minimum size and resources.
     * 
     */
    public Output<DeploymentElasticsearchMlAutoscalingArgs> autoscaling() {
    ...
    private DeploymentElasticsearchMlArgs(DeploymentElasticsearchMlArgs $) {
    ...
    public static Builder builder(DeploymentElasticsearchMlArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeploymentElasticsearchMlArgs();
        }

        public Builder(DeploymentElasticsearchMlArgs defaults) {
            $ = new DeploymentElasticsearchMlArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder autoscaling(Output<DeploymentElasticsearchMlAutoscalingArgs> autoscaling) {
         ...
         * 
         */
        public Builder autoscaling(DeploymentElasticsearchMlAutoscalingArgs autoscaling) {
