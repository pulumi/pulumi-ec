...
@CustomType
public final class DeploymentKibanaTopology {
    /**
    ...
    public static Builder builder(DeploymentKibanaTopology defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer zoneCount;
        public Builder() {}
        public Builder(DeploymentKibanaTopology defaults) {
        ...
        public DeploymentKibanaTopology build() {
            final var o = new DeploymentKibanaTopology();
