...
@CustomType
public final class GetDeploymentTemplatesTemplateApm {
    ...
    private GetDeploymentTemplatesTemplateApm() {}
    ...
    public static Builder builder(GetDeploymentTemplatesTemplateApm defaults) {
    ...
    public static final class Builder {
        ...
        private String sizeResource;
        public Builder() {}
        public Builder(GetDeploymentTemplatesTemplateApm defaults) {
        ...
        public Builder availableSizes(List<String> availableSizes) {
            if (availableSizes == null) {
              throw new MissingRequiredPropertyException("GetDeploymentTemplatesTemplateApm", "availableSizes");
            }
        ...
        public Builder defaultSize(String defaultSize) {
            if (defaultSize == null) {
              throw new MissingRequiredPropertyException("GetDeploymentTemplatesTemplateApm", "defaultSize");
            }
        ...
        public Builder instanceConfigurationId(String instanceConfigurationId) {
            if (instanceConfigurationId == null) {
              throw new MissingRequiredPropertyException("GetDeploymentTemplatesTemplateApm", "instanceConfigurationId");
            }
        ...
        public Builder instanceConfigurationVersion(Double instanceConfigurationVersion) {
            if (instanceConfigurationVersion == null) {
              throw new MissingRequiredPropertyException("GetDeploymentTemplatesTemplateApm", "instanceConfigurationVersion");
            }
        ...
        public Builder sizeResource(String sizeResource) {
            if (sizeResource == null) {
              throw new MissingRequiredPropertyException("GetDeploymentTemplatesTemplateApm", "sizeResource");
            }
            this.sizeResource = sizeResource;
            return this;
        }
        public GetDeploymentTemplatesTemplateApm build() {
            final var _resultValue = new GetDeploymentTemplatesTemplateApm();
