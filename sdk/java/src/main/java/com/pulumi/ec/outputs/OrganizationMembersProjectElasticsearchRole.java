...
@CustomType
public final class OrganizationMembersProjectElasticsearchRole {
    /**
    ...
    public static Builder builder(OrganizationMembersProjectElasticsearchRole defaults) {
    ...
    public static final class Builder {
        ...
        private String role;
        public Builder() {}
        public Builder(OrganizationMembersProjectElasticsearchRole defaults) {
        ...
        public Builder role(String role) {
            if (role == null) {
              throw new MissingRequiredPropertyException("OrganizationMembersProjectElasticsearchRole", "role");
            }
            this.role = role;
            return this;
        }
        public OrganizationMembersProjectElasticsearchRole build() {
            final var _resultValue = new OrganizationMembersProjectElasticsearchRole();
