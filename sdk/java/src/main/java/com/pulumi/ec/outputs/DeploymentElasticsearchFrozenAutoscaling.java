...
@CustomType
public final class DeploymentElasticsearchFrozenAutoscaling {
    /**
    ...
    public static Builder builder(DeploymentElasticsearchFrozenAutoscaling defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String policyOverrideJson;
        public Builder() {}
        public Builder(DeploymentElasticsearchFrozenAutoscaling defaults) {
        ...
        public DeploymentElasticsearchFrozenAutoscaling build() {
            final var _resultValue = new DeploymentElasticsearchFrozenAutoscaling();
