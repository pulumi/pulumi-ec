...
class GetDeploymentsResult:
    ...
    def deployment_template_id(self) -> Optional[builtins.str]:
        """
    ...
    def return_count(self) -> builtins.int:
        """
...
def get_deployments(apms: Optional[Sequence[Union['GetDeploymentsApmArgs', 'GetDeploymentsApmArgsDict']]] = None,
                    deployment_template_id: Optional[builtins.str] = None,
    ...
    :param builtins.str deployment_template_id: Filter the result set by the ID of the deployment template the deployment is based off.
    ...
    :param builtins.str healthy: Filter the result set by their health status.
    ...
    :param builtins.str name: Filter the result by the full deployment name.
    :param builtins.str name_prefix: Prefix to filter the returned deployment list by.
    :param builtins.int size: The maximum number of deployments to return. Defaults to `100`.
    :param Mapping[str, builtins.str] tags: Filter the result set by their assigned tags.
    """
    __args__ = dict()
    __args__['apms'] = apms
...
def get_deployments_output(apms: Optional[pulumi.Input[Optional[Sequence[Union['GetDeploymentsApmArgs', 'GetDeploymentsApmArgsDict']]]]] = None,
                           deployment_template_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           ...
                           healthy: Optional[pulumi.Input[Optional[builtins.str]]] = None,
