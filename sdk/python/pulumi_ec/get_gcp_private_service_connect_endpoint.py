...
class GetGcpPrivateServiceConnectEndpointResult:
    ...
    def service_attachment_uri(self) -> _builtins.str:
        """
...
def get_gcp_private_service_connect_endpoint(region: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: Region to retrieve the Prive Link configuration for.
    """
    __args__ = dict()
...
def get_gcp_private_service_connect_endpoint_output(region: Optional[pulumi.Input[_builtins.str]] = None,
