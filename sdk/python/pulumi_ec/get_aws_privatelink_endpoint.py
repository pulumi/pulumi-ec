...
class GetAwsPrivatelinkEndpointResult:
    ...
    def vpc_service_name(self) -> _builtins.str:
        """
...
def get_aws_privatelink_endpoint(region: Optional[_builtins.str] = None,
...
def get_aws_privatelink_endpoint_output(region: Optional[pulumi.Input[_builtins.str]] = None,
