...
class GetStackResult:
    ...
    @_builtins.property
    @pulumi.getter
    def accessible(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def allowlisted(self) -> _builtins.bool:
        """
    ...
    def min_upgradable_from(self) -> _builtins.str:
        """
    ...
    def upgradable_tos(self) -> Sequence[_builtins.str]:
        """
    ...
    def version_regex(self) -> _builtins.str:
        """
...
def get_stack(lock: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool lock: Lock the `latest` `version_regex` obtained, so that the new stack release doesn't cascade the changes down to the deployments. It can be changed at any time.
    :param _builtins.str region: Region where the stack pack is. For Elastic Cloud Enterprise (ECE) installations, use `ece-region`.
    :param _builtins.str version_regex: Regex to filter the available stacks. Can be any valid regex expression, when multiple stacks are matched through a regex, the latest version is returned. `latest` is also accepted to obtain the latest available stack version.
    """
    __args__ = dict()
    __args__['lock'] = lock
...
def get_stack_output(lock: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
                     region: Optional[pulumi.Input[_builtins.str]] = None,
                     version_regex: Optional[pulumi.Input[_builtins.str]] = None,
