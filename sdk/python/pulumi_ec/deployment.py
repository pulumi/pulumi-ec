...
class DeploymentArgs:
    def __init__(__self__, *,
                 deployment_template_id: pulumi.Input[builtins.str],
                 ...
                 migrate_to_latest_hardware: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 reset_elasticsearch_password: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 traffic_filters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Deployment resource.
        :param pulumi.Input[builtins.str] deployment_template_id: Deployment template identifier to create the deployment from. See the [full list](https://www.elastic.co/guide/en/cloud/current/ec-regions-templates-instances.html) of regions and deployment templates available in ESS.
        ...
        :param pulumi.Input[builtins.str] version: Elastic Stack version to use for all of the deployment resources.
        :param pulumi.Input[builtins.str] alias: Deployment alias, affects the format of the resource URLs. Set to an empty value ("") to disable the alias.
        ...
        :param pulumi.Input[builtins.bool] migrate_to_latest_hardware: When set to true, the deployment will be updated according to the latest deployment template values. > **Note** If the
        ...
        :param pulumi.Input[builtins.str] name: Name for the deployment
        ...
        :param pulumi.Input[builtins.str] request_id: Request ID to set when you create the deployment. Use it only when previous attempts return an error and `request_id` is
               returned as part of the error.
        :param pulumi.Input[builtins.bool] reset_elasticsearch_password: Explicitly resets the elasticsearch_password when true
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] tags: Optional map of deployment tags
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] traffic_filters: List of traffic filters rule identifiers that will be applied to the deployment.
        """
    ...
    def deployment_template_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def deployment_template_id(self, value: pulumi.Input[builtins.str]):
    ...
    def migrate_to_latest_hardware(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def migrate_to_latest_hardware(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def reset_elasticsearch_password(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def reset_elasticsearch_password(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def traffic_filters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def traffic_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _DeploymentState:
    def __init__(__self__, *,
                 alias: Optional[pulumi.Input[builtins.str]] = None,
                 apm: Optional[pulumi.Input['DeploymentApmArgs']] = None,
                 apm_secret_token: Optional[pulumi.Input[builtins.str]] = None,
                 deployment_template_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] deployment_template_id: Deployment template identifier to create the deployment from. See the [full list](https://www.elastic.co/guide/en/cloud/current/ec-regions-templates-instances.html) of regions and deployment templates available in ESS.
        :param pulumi.Input['DeploymentElasticsearchArgs'] elasticsearch: Elasticsearch cluster definition
        :param pulumi.Input[builtins.str] elasticsearch_username: Username for authenticating to the Elasticsearch resource.
        :param pulumi.Input['DeploymentEnterpriseSearchArgs'] enterprise_search: Enterprise Search cluster definition.
        :param pulumi.Input['DeploymentIntegrationsServerArgs'] integrations_server: Integrations Server cluster definition. Integrations Server replaces `apm` in Stack versions > 8.0
        :param pulumi.Input['DeploymentKibanaArgs'] kibana: Kibana cluster definition. > **Note on disabling Kibana** While optional it is recommended deployments specify a Kibana
               block, since not doing so might cause issues when modifying or upgrading the deployment.
    ...
    def apm_secret_token(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "apm_secret_token")

    @apm_secret_token.setter
    def apm_secret_token(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "apm_secret_token", value)

    @property
    @pulumi.getter(name="deploymentTemplateId")
    def deployment_template_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Deployment template identifier to create the deployment from. See the [full list](https://www.elastic.co/guide/en/cloud/current/ec-regions-templates-instances.html) of regions and deployment templates available in ESS.
        """
        return pulumi.get(self, "deployment_template_id")
    ...
    @deployment_template_id.setter
    def deployment_template_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "deployment_template_id", value)
...
class Deployment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            traffic_filters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'Deployment':
        """
    ...
    @property
    @pulumi.getter(name="apmSecretToken")
    def apm_secret_token(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "apm_secret_token")

    @property
    @pulumi.getter(name="deploymentTemplateId")
    def deployment_template_id(self) -> pulumi.Output[builtins.str]:
        """
        Deployment template identifier to create the deployment from. See the [full list](https://www.elastic.co/guide/en/cloud/current/ec-regions-templates-instances.html) of regions and deployment templates available in ESS.
        """
        return pulumi.get(self, "deployment_template_id")
    ...
    @property
    @pulumi.getter(name="migrateToLatestHardware")
    def migrate_to_latest_hardware(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        When set to true, the deployment will be updated according to the latest deployment template values. > **Note** If the
        <code>instance_configuration_id</code> or <code>instance_configuration_version</code> fields are set for a specific
        topology element, that element will not be updated. > **Note** Hardware migrations are not supported for deployments
    ...
    @property
    @pulumi.getter(name="resetElasticsearchPassword")
    def reset_elasticsearch_password(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Explicitly resets the elasticsearch_password when true
        """
        return pulumi.get(self, "reset_elasticsearch_password")
    ...
    @property
    @pulumi.getter(name="trafficFilters")
    def traffic_filters(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of traffic filters rule identifiers that will be applied to the deployment.
        """
        return pulumi.get(self, "traffic_filters")
