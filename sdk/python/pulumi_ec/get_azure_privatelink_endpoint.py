...
class GetAzurePrivatelinkEndpointResult:
    ...
    def service_alias(self) -> _builtins.str:
        """
...
def get_azure_privatelink_endpoint(region: Optional[_builtins.str] = None,
    ...
    :param _builtins.str region: Region to retrieve the Private Link configuration for.
    """
    __args__ = dict()
...
def get_azure_privatelink_endpoint_output(region: Optional[pulumi.Input[_builtins.str]] = None,
