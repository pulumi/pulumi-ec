...
class GetAzurePrivatelinkEndpointResult:
    ...
    def service_alias(self) -> builtins.str:
        """
...
def get_azure_privatelink_endpoint(region: Optional[builtins.str] = None,
    ...
    :param builtins.str region: Region to retrieve the Private Link configuration for.
    """
    __args__ = dict()
...
def get_azure_privatelink_endpoint_output(region: Optional[pulumi.Input[builtins.str]] = None,
