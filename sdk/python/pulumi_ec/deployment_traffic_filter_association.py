...
class DeploymentTrafficFilterAssociationArgs:
    def __init__(__self__, *,
                 ...
                 traffic_filter_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a DeploymentTrafficFilterAssociation resource.
        :param pulumi.Input[builtins.str] deployment_id: Required deployment ID where the traffic filter will be associated
        :param pulumi.Input[builtins.str] traffic_filter_id: Required traffic filter ruleset ID to tie to a deployment
        """
    ...
    def traffic_filter_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def traffic_filter_id(self, value: pulumi.Input[builtins.str]):
...
class _DeploymentTrafficFilterAssociationState:
    def __init__(__self__, *,
                 ...
                 traffic_filter_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="trafficFilterId")
    def traffic_filter_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Required traffic filter ruleset ID to tie to a deployment
        """
        return pulumi.get(self, "traffic_filter_id")
    ...
    @traffic_filter_id.setter
    def traffic_filter_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "traffic_filter_id", value)


@pulumi.type_token("ec:index/deploymentTrafficFilterAssociation:DeploymentTrafficFilterAssociation")
class DeploymentTrafficFilterAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            deployment_id: Optional[pulumi.Input[builtins.str]] = None,
            traffic_filter_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DeploymentTrafficFilterAssociation':
        """
    ...
    @property
    @pulumi.getter(name="trafficFilterId")
    def traffic_filter_id(self) -> pulumi.Output[builtins.str]:
        """
        Required traffic filter ruleset ID to tie to a deployment
        """
        return pulumi.get(self, "traffic_filter_id")
