...
class SecurityProjectArgs:
    def __init__(__self__, *,
                 ...
                 admin_features_package: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] admin_features_package: admin features package (BYOK, BYOIDP, CCS, CCR)
    ...
    def admin_features_package(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def admin_features_package(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SecurityProject(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            product_types: Optional[pulumi.Input[Sequence[pulumi.Input[Union['SecurityProjectProductTypeArgs', 'SecurityProjectProductTypeArgsDict']]]]] = None,
            region_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'SecurityProject':
        """
    ...
    @property
    @pulumi.getter(name="adminFeaturesPackage")
    def admin_features_package(self) -> pulumi.Output[builtins.str]:
        """
        admin features package (BYOK, BYOIDP, CCS, CCR)
        """
        return pulumi.get(self, "admin_features_package")
