...
class ElasticsearchProjectArgs:
    def __init__(__self__, *,
                 ...
                 optimized_for: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] region_id: Unique human-readable identifier for a region in Elastic Cloud.
        :param pulumi.Input[builtins.str] alias: A custom domain label compatible with RFC-1035 standards. Derived from the project name by default.
        :param pulumi.Input[builtins.str] name: Descriptive name for a project.
        :param pulumi.Input[builtins.str] optimized_for: The purpose for which the hardware of this elasticsearch project is optimized for. Also known as the Elasticsearch project subtype.
    ...
    def optimized_for(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def optimized_for(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ElasticsearchProjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] alias: A custom domain label compatible with RFC-1035 standards. Derived from the project name by default.
        :param pulumi.Input[builtins.str] cloud_id: The cloud ID, an encoded string that provides other Elastic services with the necessary information to connect to this Elasticsearch and Kibana.
        ...
        :param pulumi.Input[builtins.str] region_id: Unique human-readable identifier for a region in Elastic Cloud.
        :param pulumi.Input['ElasticsearchProjectSearchLakeArgs'] search_lake: Configuration for entire set of capabilities that make the data searchable in Elasticsearch.
        :param pulumi.Input[builtins.str] type: the type of the project
        """
        if alias is not None:
            pulumi.set(__self__, "alias", alias)
...
class ElasticsearchProject(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            region_id: Optional[pulumi.Input[builtins.str]] = None,
            search_lake: Optional[pulumi.Input[Union['ElasticsearchProjectSearchLakeArgs', 'ElasticsearchProjectSearchLakeArgsDict']]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'ElasticsearchProject':
        """
    ...
    @property
    @pulumi.getter(name="optimizedFor")
    def optimized_for(self) -> pulumi.Output[builtins.str]:
        """
        The purpose for which the hardware of this elasticsearch project is optimized for. Also known as the Elasticsearch project subtype.
        """
        return pulumi.get(self, "optimized_for")
