...
class GetDeploymentTemplatesResult:
    ...
    def show_deprecated(self) -> Optional[_builtins.bool]:
        """
    ...
    def stack_version(self) -> Optional[_builtins.str]:
        """
...
def get_deployment_templates(id: Optional[_builtins.str] = None,
                             region: Optional[_builtins.str] = None,
                             show_deprecated: Optional[_builtins.bool] = None,
                             stack_version: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: Filters for a deployment template with this id.
    :param _builtins.str region: Region to select. For Elastic Cloud Enterprise (ECE) installations, use `ece-region`.
    :param _builtins.bool show_deprecated: Enable to also show deprecated deployment templates. (Set to false by default.)
    :param _builtins.str stack_version: Filters for deployment templates compatible with this stack version.
    """
    __args__ = dict()
    __args__['id'] = id
