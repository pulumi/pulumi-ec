...
class DeploymentExtensionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] extension_type: Extension type. Must be `bundle` or `plugin`. A `bundle` will usually contain a dictionary or script, where a `plugin` is compiled from source.
        :param pulumi.Input[builtins.str] version: Elastic stack version. A full version (e.g 8.7.0) should be set for plugins. A wildcard (e.g 8.*) may be used for bundles.
        :param pulumi.Input[builtins.str] description: Description for the extension
        :param pulumi.Input[builtins.str] download_url: The URL to download the extension archive.
        :param pulumi.Input[builtins.str] file_hash: Hash value of the file. Triggers re-uploading the file on change.
        :param pulumi.Input[builtins.str] file_path: Local file path to upload as the extension.
...
class _DeploymentExtensionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] file_hash: Hash value of the file. Triggers re-uploading the file on change.
        :param pulumi.Input[builtins.str] file_path: Local file path to upload as the extension.
        :param pulumi.Input[builtins.str] last_modified: The datatime the extension was last modified.
        :param pulumi.Input[builtins.str] name: Name of the extension
        :param pulumi.Input[builtins.int] size: The size of the extension file in bytes.
        :param pulumi.Input[builtins.str] url: The extension URL which will be used in the Elastic Cloud deployment plan.
        :param pulumi.Input[builtins.str] version: Elastic stack version. A full version (e.g 8.7.0) should be set for plugins. A wildcard (e.g 8.*) may be used for bundles.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
...
class DeploymentExtension(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            size: Optional[pulumi.Input[builtins.int]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'DeploymentExtension':
        """
    ...
    @property
    @pulumi.getter(name="downloadUrl")
    def download_url(self) -> pulumi.Output[builtins.str]:
        """
        The URL to download the extension archive.
        """
        return pulumi.get(self, "download_url")
