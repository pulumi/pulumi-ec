...
if not MYPY:
    class DeploymentApmArgsDict(TypedDict):
        ...
        """
        elasticsearch_cluster_ref_id: NotRequired[pulumi.Input[builtins.str]]
        http_endpoint: NotRequired[pulumi.Input[builtins.str]]
        https_endpoint: NotRequired[pulumi.Input[builtins.str]]
        instance_configuration_id: NotRequired[pulumi.Input[builtins.str]]
        instance_configuration_version: NotRequired[pulumi.Input[builtins.int]]
        latest_instance_configuration_id: NotRequired[pulumi.Input[builtins.str]]
        latest_instance_configuration_version: NotRequired[pulumi.Input[builtins.int]]
        ref_id: NotRequired[pulumi.Input[builtins.str]]
        ...
        size_resource: NotRequired[pulumi.Input[builtins.str]]
        """
        Optional size type, defaults to "memory".
        """
        zone_count: NotRequired[pulumi.Input[builtins.int]]
elif False:
...
class DeploymentApmArgs:
    def __init__(__self__, *,
                 ...
                 elasticsearch_cluster_ref_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 instance_configuration_version: Optional[pulumi.Input[builtins.int]] = None,
                 latest_instance_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
                 latest_instance_configuration_version: Optional[pulumi.Input[builtins.int]] = None,
                 ref_id: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 size: Optional[pulumi.Input[builtins.str]] = None,
                 size_resource: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] size_resource: Optional size type, defaults to "memory".
        """
    ...
    def elasticsearch_cluster_ref_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "elasticsearch_cluster_ref_id")

    @elasticsearch_cluster_ref_id.setter
    def elasticsearch_cluster_ref_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def size_resource(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Optional size type, defaults to "memory".
        """
    ...
    def size_resource(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DeploymentApmConfigArgsDict(TypedDict):
        debug_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Optionally enable debug mode for APM servers - defaults to false
        """
        docker_image: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        user_settings_json: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        user_settings_override_json: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        user_settings_override_yaml: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        user_settings_yaml: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeploymentApmConfigArgs:
    def __init__(__self__, *,
                 debug_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 docker_image: Optional[pulumi.Input[builtins.str]] = None,
                 user_settings_json: Optional[pulumi.Input[builtins.str]] = None,
                 user_settings_override_json: Optional[pulumi.Input[builtins.str]] = None,
                 user_settings_override_yaml: Optional[pulumi.Input[builtins.str]] = None,
                 user_settings_yaml: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] debug_enabled: Optionally enable debug mode for APM servers - defaults to false
        :param pulumi.Input[builtins.str] docker_image: Optionally override the docker image the APM nodes will use. This option will not work in ESS customers and should only be changed if you know what you're doing.
        :param pulumi.Input[builtins.str] user_settings_json: An arbitrary JSON object allowing (non-admin) cluster owners to set their parameters (only one of this and 'user*settings*yaml' is allowed), provided they are on the whitelist ('user*settings*whitelist') and not on the blacklist ('user*settings*blacklist'). (This field together with 'user*settings*override*' and 'system_settings' defines the total set of resource settings)
        :param pulumi.Input[builtins.str] user_settings_override_json: An arbitrary JSON object allowing ECE admins owners to set clusters' parameters (only one of this and 'user*settings*override*yaml' is allowed), ie in addition to the documented 'system*settings'. (This field together with 'system*settings' and 'user*settings*' defines the total set of resource settings)
        :param pulumi.Input[builtins.str] user_settings_override_yaml: An arbitrary YAML object allowing ECE admins owners to set clusters' parameters (only one of this and 'user*settings*override*json' is allowed), ie in addition to the documented 'system*settings'. (This field together with 'system*settings' and 'user*settings*' defines the total set of resource settings)
        :param pulumi.Input[builtins.str] user_settings_yaml: An arbitrary YAML object allowing (non-admin) cluster owners to set their parameters (only one of this and 'user*settings*json' is allowed), provided they are on the whitelist ('user*settings*whitelist') and not on the blacklist ('user*settings*blacklist'). (These field together with 'user*settings*override*' and 'system_settings' defines the total set of resource settings)
        """
    ...
    def debug_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Optionally enable debug mode for APM servers - defaults to false
        """
    ...
    def debug_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def user_settings_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An arbitrary JSON object allowing (non-admin) cluster owners to set their parameters (only one of this and 'user*settings*yaml' is allowed), provided they are on the whitelist ('user*settings*whitelist') and not on the blacklist ('user*settings*blacklist'). (This field together with 'user*settings*override*' and 'system_settings' defines the total set of resource settings)
        """
    ...
    def user_settings_json(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_settings_json", value)

    @property
    @pulumi.getter(name="userSettingsOverrideJson")
    def user_settings_override_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An arbitrary JSON object allowing ECE admins owners to set clusters' parameters (only one of this and 'user*settings*override*yaml' is allowed), ie in addition to the documented 'system*settings'. (This field together with 'system*settings' and 'user*settings*' defines the total set of resource settings)
        """
    ...
    def user_settings_override_json(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_settings_override_json", value)

    @property
    @pulumi.getter(name="userSettingsOverrideYaml")
    def user_settings_override_yaml(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An arbitrary YAML object allowing ECE admins owners to set clusters' parameters (only one of this and 'user*settings*override*json' is allowed), ie in addition to the documented 'system*settings'. (This field together with 'system*settings' and 'user*settings*' defines the total set of resource settings)
        """
    ...
    def user_settings_override_yaml(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "user_settings_override_yaml", value)

    @property
    @pulumi.getter(name="userSettingsYaml")
    def user_settings_yaml(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An arbitrary YAML object allowing (non-admin) cluster owners to set their parameters (only one of this and 'user*settings*json' is allowed), provided they are on the whitelist ('user*settings*whitelist') and not on the blacklist ('user*settings*blacklist'). (These field together with 'user*settings*override*' and 'system_settings' defines the total set of resource settings)
        """
    ...
    def user_settings_yaml(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DeploymentElasticsearchArgsDict(TypedDict):
        ...
        """
        autoscale: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DeploymentElasticsearchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] autoscale: Enable or disable autoscaling. Defaults to the setting coming from the deployment template.
        :param pulumi.Input[builtins.str] cloud_id: The encoded Elasticsearch credentials to use in Beats or Logstash
        ...
        :param pulumi.Input[builtins.str] http_endpoint: The Elasticsearch resource HTTP endpoint
        :param pulumi.Input[builtins.str] https_endpoint: The Elasticsearch resource HTTPs endpoint
        ...
        :param pulumi.Input[builtins.str] ref_id: A human readable reference for the Elasticsearch resource. The default value `main-elasticsearch` is recommended.
        :param pulumi.Input[builtins.str] region: Elasticsearch Service (ESS) region where the deployment should be hosted. For Elastic Cloud Enterprise (ECE) installations, set to `"ece-region".
        ...
        :param pulumi.Input[builtins.str] resource_id: The Elasticsearch resource unique identifier
        ...
        :param pulumi.Input[builtins.str] strategy: Configuration strategy type autodetect, grow_and_shrink, rolling_grow_and_shrink, rolling_all
...
if not MYPY:
    class DeploymentElasticsearchColdArgsDict(TypedDict):
        ...
        """
        node_roles: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        The computed list of node roles for the current topology element
        """
        node_type_data: NotRequired[pulumi.Input[builtins.str]]
        """
        The node type for the Elasticsearch Topology element (data node)
        """
        node_type_ingest: NotRequired[pulumi.Input[builtins.str]]
        """
        The node type for the Elasticsearch Topology element (ingest node)
        """
        node_type_master: NotRequired[pulumi.Input[builtins.str]]
        """
        The node type for the Elasticsearch Topology element (master node)
        """
        node_type_ml: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeploymentElasticsearchColdArgs:
    def __init__(__self__, *,
                 ...
                 latest_instance_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
                 latest_instance_configuration_version: Optional[pulumi.Input[builtins.int]] = None,
                 node_roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 node_type_data: Optional[pulumi.Input[builtins.str]] = None,
                 node_type_ingest: Optional[pulumi.Input[builtins.str]] = None,
                 node_type_master: Optional[pulumi.Input[builtins.str]] = None,
                 node_type_ml: Optional[pulumi.Input[builtins.str]] = None,
                 size: Optional[pulumi.Input[builtins.str]] = None,
                 size_resource: Optional[pulumi.Input[builtins.str]] = None,
                 zone_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] instance_configuration_id: Instance Configuration ID of the topology element
        :param pulumi.Input[builtins.int] instance_configuration_version: Instance Configuration version of the topology element
        :param pulumi.Input[builtins.str] latest_instance_configuration_id: Latest Instance Configuration ID available on the deployment template for the topology element
        :param pulumi.Input[builtins.int] latest_instance_configuration_version: Latest version available for the Instance Configuration with the latest*instance*configuration_id
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] node_roles: The computed list of node roles for the current topology element
        :param pulumi.Input[builtins.str] node_type_data: The node type for the Elasticsearch Topology element (data node)
        :param pulumi.Input[builtins.str] node_type_ingest: The node type for the Elasticsearch Topology element (ingest node)
        :param pulumi.Input[builtins.str] node_type_master: The node type for the Elasticsearch Topology element (master node)
        :param pulumi.Input[builtins.str] node_type_ml: The node type for the Elasticsearch Topology element (machine learning node)
        :param pulumi.Input[builtins.str] size: Amount of "size_resource" per node in the "\\n\\ng" notation
        :param pulumi.Input[builtins.str] size_resource: Size type, defaults to "memory".
        :param pulumi.Input[builtins.int] zone_count: Number of zones that the Elasticsearch cluster will span. This is used to set HA
        """
    ...
    def node_roles(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The computed list of node roles for the current topology element
        """
    ...
    @node_roles.setter
    def node_roles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "node_roles", value)

    @property
    @pulumi.getter(name="nodeTypeData")
    def node_type_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The node type for the Elasticsearch Topology element (data node)
        """
    ...
    def node_type_data(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "node_type_data", value)

    @property
    @pulumi.getter(name="nodeTypeIngest")
    def node_type_ingest(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The node type for the Elasticsearch Topology element (ingest node)
        """
    ...
    def node_type_ingest(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "node_type_ingest", value)

    @property
    @pulumi.getter(name="nodeTypeMaster")
    def node_type_master(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The node type for the Elasticsearch Topology element (master node)
        """
    ...
    def node_type_master(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "node_type_master", value)

    @property
    @pulumi.getter(name="nodeTypeMl")
    def node_type_ml(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The node type for the Elasticsearch Topology element (machine learning node)
        """
    ...
    @node_type_ml.setter
    def node_type_ml(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DeploymentElasticsearchColdAutoscalingArgsDict(TypedDict):
        ...
        """
        max_size: NotRequired[pulumi.Input[builtins.str]]
        """
        Maximum size value for the maximum autoscaling setting.
        """
        max_size_resource: NotRequired[pulumi.Input[builtins.str]]
        """
        Maximum resource type for the maximum autoscaling setting.
        """
        min_size: NotRequired[pulumi.Input[builtins.str]]
        """
        Minimum size value for the minimum autoscaling setting.
        """
        min_size_resource: NotRequired[pulumi.Input[builtins.str]]
        """
        Minimum resource type for the minimum autoscaling setting.
        """
        policy_override_json: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeploymentElasticsearchColdAutoscalingArgs:
    def __init__(__self__, *,
                 ...
                 max_size_resource: Optional[pulumi.Input[builtins.str]] = None,
                 min_size: Optional[pulumi.Input[builtins.str]] = None,
                 min_size_resource: Optional[pulumi.Input[builtins.str]] = None,
                 policy_override_json: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] autoscale: Whether this specific tier should be auto-scaled, overrides deployment-wide setting. Allowed for `ml` tier only.
        :param pulumi.Input[builtins.str] max_size: Maximum size value for the maximum autoscaling setting.
        :param pulumi.Input[builtins.str] max_size_resource: Maximum resource type for the maximum autoscaling setting.
        :param pulumi.Input[builtins.str] min_size: Minimum size value for the minimum autoscaling setting.
        :param pulumi.Input[builtins.str] min_size_resource: Minimum resource type for the minimum autoscaling setting.
        :param pulumi.Input[builtins.str] policy_override_json: Computed policy overrides set directly via the API or other clients.
        """
        if autoscale is not None:
            pulumi.set(__self__, "autoscale", autoscale)
    ...
    def max_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Maximum size value for the maximum autoscaling setting.
        """
    ...
    @max_size.setter
    def max_size(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "max_size", value)

    @property
    @pulumi.getter(name="maxSizeResource")
    def max_size_resource(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Maximum resource type for the maximum autoscaling setting.
        """
    ...
    def max_size_resource(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "max_size_resource", value)

    @property
    @pulumi.getter(name="minSize")
    def min_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Minimum size value for the minimum autoscaling setting.
        """
    ...
    @min_size.setter
    def min_size(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "min_size", value)

    @property
    @pulumi.getter(name="minSizeResource")
    def min_size_resource(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Minimum resource type for the minimum autoscaling setting.
        """
    ...
    def min_size_resource(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "min_size_resource", value)

    @property
    @pulumi.getter(name="policyOverrideJson")
    def policy_override_json(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Computed policy overrides set directly via the API or other clients.
        """
    ...
    def policy_override_json(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DeploymentElasticsearchConfigArgs:
    def __init__(__self__, *,
                 ...
                 user_settings_yaml: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] docker_image: Overrides the docker image the Elasticsearch nodes will use. Note that this field will only work for internal users only.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] plugins: List of Elasticsearch supported plugins, which vary from version to version. Check the Stack Pack version to see which plugins are supported for each version. This is currently only available from the UI and [ecctl](https://www.elastic.co/guide/en/ecctl/master/ecctl_stack_list.html)
        :param pulumi.Input[builtins.str] user_settings_json: JSON-formatted user level "elasticsearch.yml" setting overrides
        :param pulumi.Input[builtins.str] user_settings_override_json: JSON-formatted admin (ECE) level "elasticsearch.yml" setting overrides
        :param pulumi.Input[builtins.str] user_settings_override_yaml: YAML-formatted admin (ECE) level "elasticsearch.yml" setting overrides
        :param pulumi.Input[builtins.str] user_settings_yaml: YAML-formatted user level "elasticsearch.yml" setting overrides
        """
        if docker_image is not None:
            pulumi.set(__self__, "docker_image", docker_image)
...
class DeploymentElasticsearchExtensionArgs:
    def __init__(__self__, *,
                 ...
                 version: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: Extension name.
        :param pulumi.Input[builtins.str] type: Extension type, only `bundle` or `plugin` are supported.
        :param pulumi.Input[builtins.str] url: Bundle or plugin URL, the extension URL can be obtained from the `ec_deployment_extension.<name>.url` attribute or the API and cannot be a random HTTP address that is hosted elsewhere.
        :param pulumi.Input[builtins.str] version: Elasticsearch compatibility version. Bundles should specify major or minor versions with wildcards, such as `7.*` or `*` but **plugins must use full version notation down to the patch level**, such as `7.10.1` and wildcards are not allowed.
        """
...
if not MYPY:
    class DeploymentElasticsearchKeystoreContentsArgsDict(TypedDict):
        ...
        """
        as_file: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DeploymentElasticsearchKeystoreContentsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] value: Secret value. This can either be a string or a JSON object that is stored as a JSON string in the keystore.
        :param pulumi.Input[builtins.bool] as_file: If true, the secret is handled as a file. Otherwise, it's handled as a plain string.
        """
...
if not MYPY:
    class DeploymentElasticsearchRemoteClusterArgsDict(TypedDict):
        ...
        """
        skip_unavailable: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class DeploymentElasticsearchRemoteClusterArgs:
    def __init__(__self__, *,
                 ...
                 deployment_id: pulumi.Input[builtins.str],
                 ref_id: Optional[pulumi.Input[builtins.str]] = None,
                 skip_unavailable: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] alias: Alias for this Cross Cluster Search binding
        :param pulumi.Input[builtins.str] deployment_id: Remote deployment ID
        :param pulumi.Input[builtins.str] ref_id: Remote elasticsearch "ref_id", it is best left to the default value
        :param pulumi.Input[builtins.bool] skip_unavailable: If true, skip the cluster during search when disconnected
        """
    ...
    def skip_unavailable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If true, skip the cluster during search when disconnected
        """
    ...
    def skip_unavailable(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DeploymentElasticsearchSnapshotArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] enabled: Indicates if Snapshotting is enabled.
...
class DeploymentElasticsearchSnapshotRepositoryReferenceArgs:
    def __init__(__self__, *,
                 repository_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] repository_name: ECE snapshot repository name, from the '/platform/configuration/snapshots/repositories' endpoint
        """
...
if not MYPY:
    class DeploymentElasticsearchSnapshotSourceArgsDict(TypedDict):
        source_elasticsearch_cluster_id: pulumi.Input[builtins.str]
        """
...
class DeploymentElasticsearchSnapshotSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] source_elasticsearch_cluster_id: ID of the Elasticsearch cluster that will be used as the source of the snapshot
        :param pulumi.Input[builtins.str] snapshot_name: Name of the snapshot to restore. Use '**latest_success**' to get the most recent successful snapshot.
        """
    ...
    def source_elasticsearch_cluster_id(self) -> pulumi.Input[builtins.str]:
        """
        ID of the Elasticsearch cluster that will be used as the source of the snapshot
        """
    ...
    def source_elasticsearch_cluster_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class DeploymentElasticsearchTrustAccountArgsDict(TypedDict):
        ...
        """
        trust_all: pulumi.Input[builtins.bool]
        """
        If true, all clusters in this account will by default be trusted and the `trust_allowlist` is ignored.
        """
        trust_allowlists: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DeploymentElasticsearchTrustAccountArgs:
    def __init__(__self__, *,
                 account_id: pulumi.Input[builtins.str],
                 trust_all: pulumi.Input[builtins.bool],
                 trust_allowlists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] account_id: The ID of the Account.
        :param pulumi.Input[builtins.bool] trust_all: If true, all clusters in this account will by default be trusted and the `trust_allowlist` is ignored.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trust_allowlists: The list of clusters to trust. Only used when `trust_all` is false.
        """
    ...
    def trust_all(self) -> pulumi.Input[builtins.bool]:
        """
        If true, all clusters in this account will by default be trusted and the `trust_allowlist` is ignored.
        """
    ...
    @trust_all.setter
    def trust_all(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "trust_all", value)

    @property
    @pulumi.getter(name="trustAllowlists")
    def trust_allowlists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of clusters to trust. Only used when `trust_all` is false.
        """
    ...
    def trust_allowlists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "trust_allowlists", value)


if not MYPY:
    class DeploymentElasticsearchTrustExternalArgsDict(TypedDict):
        relationship_id: pulumi.Input[builtins.str]
        """
...
class DeploymentElasticsearchTrustExternalArgs:
    def __init__(__self__, *,
                 ...
                 trust_allowlists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] relationship_id: The ID of the external trust relationship.
        :param pulumi.Input[builtins.bool] trust_all: If true, all clusters in this account will by default be trusted and the `trust_allowlist` is ignored.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trust_allowlists: The list of clusters to trust. Only used when `trust_all` is false.
        """
    ...
    def relationship_id(self) -> pulumi.Input[builtins.str]:
        """
        The ID of the external trust relationship.
        """
    ...
    def relationship_id(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class DeploymentEnterpriseSearchArgsDict(TypedDict):
        ...
        latest_instance_configuration_id: NotRequired[pulumi.Input[builtins.str]]
        latest_instance_configuration_version: NotRequired[pulumi.Input[builtins.int]]
        node_type_appserver: NotRequired[pulumi.Input[builtins.bool]]
        node_type_connector: NotRequired[pulumi.Input[builtins.bool]]
        node_type_worker: NotRequired[pulumi.Input[builtins.bool]]
        ref_id: NotRequired[pulumi.Input[builtins.str]]
        region: NotRequired[pulumi.Input[builtins.str]]
        resource_id: NotRequired[pulumi.Input[builtins.str]]
        size: NotRequired[pulumi.Input[builtins.str]]
...
class DeploymentEnterpriseSearchArgs:
    def __init__(__self__, *,
                 ...
                 latest_instance_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
                 latest_instance_configuration_version: Optional[pulumi.Input[builtins.int]] = None,
                 node_type_appserver: Optional[pulumi.Input[builtins.bool]] = None,
                 node_type_connector: Optional[pulumi.Input[builtins.bool]] = None,
                 node_type_worker: Optional[pulumi.Input[builtins.bool]] = None,
                 ref_id: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 size: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def node_type_appserver(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "node_type_appserver")

    @node_type_appserver.setter
    def node_type_appserver(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "node_type_appserver", value)

    @property
    @pulumi.getter(name="nodeTypeConnector")
    def node_type_connector(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "node_type_connector")

    @node_type_connector.setter
    def node_type_connector(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "node_type_connector", value)

    @property
    @pulumi.getter(name="nodeTypeWorker")
    def node_type_worker(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "node_type_worker")

    @node_type_worker.setter
    def node_type_worker(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DeploymentEnterpriseSearchConfigArgs:
    def __init__(__self__, *,
                 ...
                 user_settings_yaml: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] docker_image: Optionally override the docker image the Enterprise Search nodes will use. Note that this field will only work for internal users only.
        :param pulumi.Input[builtins.str] user_settings_json: An arbitrary JSON object allowing (non-admin) cluster owners to set their parameters (only one of this and 'user*settings*yaml' is allowed), provided they are on the whitelist ('user*settings*whitelist') and not on the blacklist ('user*settings*blacklist'). (This field together with 'user*settings*override*' and 'system_settings' defines the total set of resource settings)
        :param pulumi.Input[builtins.str] user_settings_override_json: An arbitrary JSON object allowing ECE admins owners to set clusters' parameters (only one of this and 'user*settings*override*yaml' is allowed), ie in addition to the documented 'system*settings'. (This field together with 'system*settings' and 'user*settings*' defines the total set of resource settings)
        :param pulumi.Input[builtins.str] user_settings_override_yaml: An arbitrary YAML object allowing ECE admins owners to set clusters' parameters (only one of this and 'user*settings*override*json' is allowed), ie in addition to the documented 'system*settings'. (This field together with 'system*settings' and 'user*settings*' defines the total set of resource settings)
        :param pulumi.Input[builtins.str] user_settings_yaml: An arbitrary YAML object allowing (non-admin) cluster owners to set their parameters (only one of this and 'user*settings*json' is allowed), provided they are on the whitelist ('user*settings*whitelist') and not on the blacklist ('user*settings*blacklist'). (These field together with 'user*settings*override*' and 'system_settings' defines the total set of resource settings)
...
class DeploymentIntegrationsServerConfigArgs:
    def __init__(__self__, *,
                 ...
                 user_settings_yaml: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] debug_enabled: Optionally enable debug mode for Integrations Server instances - defaults to false
        :param pulumi.Input[builtins.str] docker_image: Optionally override the docker image the Integrations Server nodes will use. Note that this field will only work for internal users only.
        :param pulumi.Input[builtins.str] user_settings_json: An arbitrary JSON object allowing (non-admin) cluster owners to set their parameters (only one of this and 'user*settings*yaml' is allowed), provided they are on the whitelist ('user*settings*whitelist') and not on the blacklist ('user*settings*blacklist'). (This field together with 'user*settings*override*' and 'system_settings' defines the total set of resource settings)
        :param pulumi.Input[builtins.str] user_settings_override_json: An arbitrary JSON object allowing ECE admins owners to set clusters' parameters (only one of this and 'user*settings*override*yaml' is allowed), ie in addition to the documented 'system*settings'. (This field together with 'system*settings' and 'user*settings*' defines the total set of resource settings)
        :param pulumi.Input[builtins.str] user_settings_override_yaml: An arbitrary YAML object allowing ECE admins owners to set clusters' parameters (only one of this and 'user*settings*override*json' is allowed), ie in addition to the documented 'system*settings'. (This field together with 'system*settings' and 'user*settings*' defines the total set of resource settings)
        :param pulumi.Input[builtins.str] user_settings_yaml: An arbitrary YAML object allowing (non-admin) cluster owners to set their parameters (only one of this and 'user*settings*json' is allowed), provided they are on the whitelist ('user*settings*whitelist') and not on the blacklist ('user*settings*blacklist'). (These field together with 'user*settings*override*' and 'system_settings' defines the total set of resource settings)
...
if not MYPY:
    class DeploymentIntegrationsServerEndpointsArgsDict(TypedDict):
        apm: pulumi.Input[builtins.str]
        fleet: pulumi.Input[builtins.str]
        profiling: pulumi.Input[builtins.str]
        symbols: pulumi.Input[builtins.str]
elif False:
...
class DeploymentIntegrationsServerEndpointsArgs:
    ...
    @property
    @pulumi.getter
    def apm(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "apm")

    @apm.setter
    def apm(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "apm", value)

    @property
    @pulumi.getter
    def fleet(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "fleet")

    @fleet.setter
    def fleet(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "fleet", value)

    @property
    @pulumi.getter
    def profiling(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "profiling")

    @profiling.setter
    def profiling(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "profiling", value)

    @property
    @pulumi.getter
    def symbols(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "symbols")

    @symbols.setter
    def symbols(self, value: pulumi.Input[builtins.str]):
...
class DeploymentKibanaConfigArgs:
    def __init__(__self__, *,
                 ...
                 user_settings_yaml: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] docker_image: Optionally override the docker image the Kibana nodes will use. Note that this field will only work for internal users only.
        :param pulumi.Input[builtins.str] user_settings_json: An arbitrary JSON object allowing (non-admin) cluster owners to set their parameters (only one of this and 'user*settings*yaml' is allowed), provided they are on the whitelist ('user*settings*whitelist') and not on the blacklist ('user*settings*blacklist'). (This field together with 'user*settings*override*' and 'system_settings' defines the total set of resource settings)
        :param pulumi.Input[builtins.str] user_settings_override_json: An arbitrary JSON object allowing ECE admins owners to set clusters' parameters (only one of this and 'user*settings*override*yaml' is allowed), ie in addition to the documented 'system*settings'. (This field together with 'system*settings' and 'user*settings*' defines the total set of resource settings)
        :param pulumi.Input[builtins.str] user_settings_override_yaml: An arbitrary YAML object allowing ECE admins owners to set clusters' parameters (only one of this and 'user*settings*override*json' is allowed), ie in addition to the documented 'system*settings'. (This field together with 'system*settings' and 'user*settings*' defines the total set of resource settings)
        :param pulumi.Input[builtins.str] user_settings_yaml: An arbitrary YAML object allowing (non-admin) cluster owners to set their parameters (only one of this and 'user*settings*json' is allowed), provided they are on the whitelist ('user*settings*whitelist') and not on the blacklist ('user*settings*blacklist'). (These field together with 'user*settings*override*' and 'system_settings' defines the total set of resource settings)
...
if not MYPY:
    class DeploymentObservabilityArgsDict(TypedDict):
        deployment_id: pulumi.Input[builtins.str]
        logs: NotRequired[pulumi.Input[builtins.bool]]
        metrics: NotRequired[pulumi.Input[builtins.bool]]
        ref_id: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
if not MYPY:
    class DeploymentTrafficFilterRuleArgsDict(TypedDict):
        azure_endpoint_guid: NotRequired[pulumi.Input[builtins.str]]
        """
        Azure endpoint GUID. Only applicable when the ruleset type is set to `azure_private_endpoint`
        """
        azure_endpoint_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeploymentTrafficFilterRuleArgs:
    def __init__(__self__, *,
                 azure_endpoint_guid: Optional[pulumi.Input[builtins.str]] = None,
                 azure_endpoint_name: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 source: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] azure_endpoint_guid: Azure endpoint GUID. Only applicable when the ruleset type is set to `azure_private_endpoint`
        :param pulumi.Input[builtins.str] azure_endpoint_name: Azure endpoint name. Only applicable when the ruleset type is set to `azure_private_endpoint`
        :param pulumi.Input[builtins.str] description: Description of this individual rule
        :param pulumi.Input[builtins.str] id: Computed rule ID
        :param pulumi.Input[builtins.str] source: Traffic filter source: IP address, CIDR mask, or VPC endpoint ID, **only required** when the type is not `azure_private_endpoint`
        """
    ...
    def azure_endpoint_guid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Azure endpoint GUID. Only applicable when the ruleset type is set to `azure_private_endpoint`
        """
    ...
    def azure_endpoint_guid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "azure_endpoint_guid", value)

    @property
    @pulumi.getter(name="azureEndpointName")
    def azure_endpoint_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Azure endpoint name. Only applicable when the ruleset type is set to `azure_private_endpoint`
        """
    ...
    def azure_endpoint_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ElasticsearchProjectCredentialsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] password: Basic auth password that can be used to access the Elasticsearch API.
        :param pulumi.Input[builtins.str] username: Basic auth username that can be used to access the Elasticsearch API.
        """
...
if not MYPY:
    class ElasticsearchProjectEndpointsArgsDict(TypedDict):
        ...
        """
        kibana: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ElasticsearchProjectEndpointsArgs:
    def __init__(__self__, *,
                 ...
                 kibana: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] elasticsearch: The endpoint to access elasticsearch.
        :param pulumi.Input[builtins.str] kibana: The endpoint to access kibana.
        """
    ...
    @property
    @pulumi.getter
    def kibana(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The endpoint to access kibana.
        """
    ...
    @kibana.setter
    def kibana(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ElasticsearchProjectMetadataArgsDict(TypedDict):
        ...
        """
        suspended_at: NotRequired[pulumi.Input[builtins.str]]
        """
        Date and time when the project was suspended.
        """
        suspended_reason: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ElasticsearchProjectMetadataArgs:
    def __init__(__self__, *,
                 ...
                 suspended_at: Optional[pulumi.Input[builtins.str]] = None,
                 suspended_reason: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] created_at: Date and time when the project was created.
        :param pulumi.Input[builtins.str] created_by: ID of the user.
        :param pulumi.Input[builtins.str] organization_id: The Organization ID who owns the project.
        :param pulumi.Input[builtins.str] suspended_at: Date and time when the project was suspended.
        :param pulumi.Input[builtins.str] suspended_reason: Reason why the project was suspended.
        """
    ...
    def suspended_at(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Date and time when the project was suspended.
        """
    ...
    @suspended_at.setter
    def suspended_at(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "suspended_at", value)

    @property
    @pulumi.getter(name="suspendedReason")
    def suspended_reason(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Reason why the project was suspended.
        """
    ...
    def suspended_reason(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "suspended_reason", value)


if not MYPY:
    class ElasticsearchProjectSearchLakeArgsDict(TypedDict):
        boost_window: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        search_power: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ElasticsearchProjectSearchLakeArgs:
    def __init__(__self__, *,
                 boost_window: Optional[pulumi.Input[builtins.int]] = None,
                 search_power: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] boost_window: Determines how much data can benefit from faster search. When ingested, a certain amount of data is loaded into a cache that makes it super fast to query. The system dynamically adjusts the cache allocated to your project based on how much data you ingest during the period defined by your Search Boost Window.
        :param pulumi.Input[builtins.int] search_power: Controls how fast searches are against your project data. When ingested, a certain amount of data is loaded into a cache that makes it super fast to query. You can either increase the performance of searches on cached data by adding replicas, or reduce the quantity of cached data by a static factor to save on costs.
        """
    ...
    def boost_window(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Determines how much data can benefit from faster search. When ingested, a certain amount of data is loaded into a cache that makes it super fast to query. The system dynamically adjusts the cache allocated to your project based on how much data you ingest during the period defined by your Search Boost Window.
        """
    ...
    @boost_window.setter
    def boost_window(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "boost_window", value)

    @property
    @pulumi.getter(name="searchPower")
    def search_power(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Controls how fast searches are against your project data. When ingested, a certain amount of data is loaded into a cache that makes it super fast to query. You can either increase the performance of searches on cached data by adding replicas, or reduce the quantity of cached data by a static factor to save on costs.
        """
    ...
    @search_power.setter
    def search_power(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ObservabilityProjectEndpointsArgsDict(TypedDict):
        apm: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ObservabilityProjectEndpointsArgs:
    def __init__(__self__, *,
                 apm: Optional[pulumi.Input[builtins.str]] = None,
                 elasticsearch: Optional[pulumi.Input[builtins.str]] = None,
                 kibana: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] apm: The endpoint to access apm.
        :param pulumi.Input[builtins.str] elasticsearch: The endpoint to access elasticsearch.
        :param pulumi.Input[builtins.str] kibana: The endpoint to access kibana.
        """
        if apm is not None:
    ...
    @property
    @pulumi.getter
    def apm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The endpoint to access apm.
        """
        return pulumi.get(self, "apm")
    ...
    @apm.setter
    def apm(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "apm", value)
...
if not MYPY:
    class OrganizationMembersArgsDict(TypedDict):
        ...
        """
        invitation_pending: NotRequired[pulumi.Input[builtins.bool]]
        """
        Set to true while the user has not yet accepted their invitation to the organization.
        """
        organization_role: NotRequired[pulumi.Input[builtins.str]]
        """
...
class OrganizationMembersArgs:
    def __init__(__self__, *,
                 ...
                 invitation_pending: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] invitation_pending: Set to true while the user has not yet accepted their invitation to the organization.
        :param pulumi.Input[builtins.str] organization_role: The optional organization role for the member. Can be one of `organization-admin`, `billing-admin`. For more info see: [Organization roles](https://www.elastic.co/guide/en/cloud/current/ec-user-privileges.html#ec_organization_level_roles)
    ...
    def invitation_pending(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Set to true while the user has not yet accepted their invitation to the organization.
        """
    ...
    def invitation_pending(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class OrganizationMembersDeploymentRoleArgsDict(TypedDict):
        ...
        """
        all_deployments: NotRequired[pulumi.Input[builtins.bool]]
        """
        Role applies to all deployments in the organization.
        """
        application_roles: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        deployment_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class OrganizationMembersDeploymentRoleArgs:
    def __init__(__self__, *,
                 role: pulumi.Input[builtins.str],
                 all_deployments: Optional[pulumi.Input[builtins.bool]] = None,
                 application_roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 deployment_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] role: Assigned role. Must be on of `viewer`, `editor` or `admin`.
        :param pulumi.Input[builtins.bool] all_deployments: Role applies to all deployments in the organization.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_roles: If provided, the user assigned this role assignment will be granted this application role when signing in to the deployment(s) specified in the role assignment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] deployment_ids: Role applies to deployments listed here.
        """
    ...
    def all_deployments(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Role applies to all deployments in the organization.
        """
    ...
    def all_deployments(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "all_deployments", value)

    @property
    @pulumi.getter(name="applicationRoles")
    def application_roles(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        If provided, the user assigned this role assignment will be granted this application role when signing in to the deployment(s) specified in the role assignment.
        """
    ...
    def application_roles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "application_roles", value)

    @property
    @pulumi.getter(name="deploymentIds")
    def deployment_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Role applies to deployments listed here.
        """
    ...
    def deployment_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class OrganizationMembersProjectElasticsearchRoleArgsDict(TypedDict):
        ...
        """
        all_projects: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class OrganizationMembersProjectElasticsearchRoleArgs:
    def __init__(__self__, *,
                 role: pulumi.Input[builtins.str],
                 all_projects: Optional[pulumi.Input[builtins.bool]] = None,
                 application_roles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 project_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] role: Assigned role. (Allowed values: `admin`, `developer`, `viewer`)
        :param pulumi.Input[builtins.bool] all_projects: Role applies to all projects in the organization.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_roles: If provided, the user assigned this role assignment will be granted this application role when signing in to the project(s) specified in the role assignment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] project_ids: Role applies to projects listed here.
        """
        pulumi.set(__self__, "role", role)
    ...
    def all_projects(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Role applies to all projects in the organization.
        """
    ...
    @all_projects.setter
    def all_projects(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class OrganizationMembersProjectObservabilityRoleArgs:
    def __init__(__self__, *,
                 ...
                 project_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] role: Assigned role. (Allowed values: `admin`, `editor`, `viewer`)
        :param pulumi.Input[builtins.bool] all_projects: Role applies to all projects in the organization.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_roles: If provided, the user assigned this role assignment will be granted this application role when signing in to the project(s) specified in the role assignment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] project_ids: Role applies to projects listed here.
        """
...
class OrganizationMembersProjectSecurityRoleArgs:
    def __init__(__self__, *,
                 ...
                 project_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] role: Assigned role. (Allowed values: `admin`, `editor`, `viewer`, `t1-analyst`, `t2-analyst`, `t3-analyst`, `threat-intel-analyst`, `rule-author`, `soc-manager`, `endpoint-operations-analyst`, `platform-engineer`, `detections-admin`, `endpoint-policy-manager`)
        :param pulumi.Input[builtins.bool] all_projects: Role applies to all projects in the organization.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] application_roles: If provided, the user assigned this role assignment will be granted this application role when signing in to the project(s) specified in the role assignment.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] project_ids: Role applies to projects listed here.
        """
...
if not MYPY:
    class SecurityProjectProductTypeArgsDict(TypedDict):
        product_line: pulumi.Input[builtins.str]
        """
        The identifier of the Security Solution product line.
        """
        product_tier: pulumi.Input[builtins.str]
        """
...
class SecurityProjectProductTypeArgs:
    def __init__(__self__, *,
                 ...
                 product_tier: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] product_line: The identifier of the Security Solution product line.
        :param pulumi.Input[builtins.str] product_tier: The identifier of the Security Solution product tier.
        """
    ...
    def product_line(self) -> pulumi.Input[builtins.str]:
        """
        The identifier of the Security Solution product line.
        """
    ...
    @product_line.setter
    def product_line(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "product_line", value)

    @property
    @pulumi.getter(name="productTier")
    def product_tier(self) -> pulumi.Input[builtins.str]:
        """
        The identifier of the Security Solution product tier.
        """
    ...
    @product_tier.setter
    def product_tier(self, value: pulumi.Input[builtins.str]):
...
class SnapshotRepositoryGenericArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] settings: An arbitrary JSON object containing the repository settings.
        :param pulumi.Input[builtins.str] type: Repository type
        """
...
if not MYPY:
    class SnapshotRepositoryS3ArgsDict(TypedDict):
        ...
        """
        path_style_access: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class SnapshotRepositoryS3Args:
    def __init__(__self__, *,
                 ...
                 path_style_access: Optional[pulumi.Input[builtins.bool]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None,
                 secret_key: Optional[pulumi.Input[builtins.str]] = None,
                 server_side_encryption: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] bucket: Name of the S3 bucket to use for snapshots.
        :param pulumi.Input[builtins.str] access_key: An S3 access key. If set, the secret_key setting must also be specified. If unset, the client will use the instance or container role instead.
        :param pulumi.Input[builtins.str] endpoint: The S3 service endpoint to connect to. This defaults to s3.amazonaws.com but the AWS documentation lists alternative S3 endpoints. If you are using an S3-compatible service then you should set this to the service’s endpoint.
        :param pulumi.Input[builtins.bool] path_style_access: Whether to force the use of the path style access pattern. If true, the path style access pattern will be used. If false, the access pattern will be automatically determined by the AWS Java SDK (See AWS documentation for details). Defaults to false.
        :param pulumi.Input[builtins.str] region: Allows specifying the signing region to use. Specifying this setting manually should not be necessary for most use cases. Generally, the SDK will correctly guess the signing region to use. It should be considered an expert level setting to support S3-compatible APIs that require v4 signatures and use a region other than the default us-east-1. Defaults to empty string which means that the SDK will try to automatically determine the correct signing region.
        :param pulumi.Input[builtins.str] secret_key: An S3 secret key. If set, the access_key setting must also be specified.
        :param pulumi.Input[builtins.bool] server_side_encryption: When set to true files are encrypted on server side using AES256 algorithm. Defaults to false.
        """
    ...
    def path_style_access(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to force the use of the path style access pattern. If true, the path style access pattern will be used. If false, the access pattern will be automatically determined by the AWS Java SDK (See AWS documentation for details). Defaults to false.
        """
    ...
    def path_style_access(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class GetDeploymentsApmArgsDict(TypedDict):
        healthy: NotRequired[builtins.str]
        """
...
class GetDeploymentsApmArgs:
    ...
    @healthy.setter
    def healthy(self, value: Optional[builtins.str]):
